...
public class GUIHelper
{
    ...
    public static bool DrawButtonWithImage(Sprite sprite, Vector2 imageSize, Vector2 buttonSize, GUIContent buttonContent, bool drawBox = true)
    {
        if(sprite == null)
            return false;
    ...
    public static void DrawCenteredToggle(ref AnimBool animation, String content)
    {
        using(new Horizontal())
        using(new Centered())
            DrawToggle(ref animation, new GUIContent(content));
    }
}
